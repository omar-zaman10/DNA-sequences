...
data1 = pd.read_csv('Data2/data_i2_rate_1.csv')
...
data2 = pd.read_csv('Data2/data_i2_rate_2.csv')
...
lengths = data2['codeword_length']



data3 = pd.read_csv('Data2/data_i2_rate_3.csv')
...
lengths = data3['codeword_length']


data4 = pd.read_csv('Data2/data_i2_rate_5.csv')
...
plot_t12_errors(t1_averages1,lengths,t1_sd1,t2_averages1,t2_sd1,R = '1/2')
plot_t12_errors(t1_averages2,lengths,t1_sd2,t2_averages2,t2_sd2,R = '2/3')
plot_t12_errors(t1_averages3,lengths,t1_sd3,t2_averages3,t2_sd3,R = '3/4')

plot_t12_errors(t1_averages4,lengths,t1_sd4,t2_averages4,t2_sd4,R = '5/6')
plot_t2()
plot_t1()
