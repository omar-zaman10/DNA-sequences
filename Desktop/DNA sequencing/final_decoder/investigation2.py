...
if __name__ == '__main__':
    '''
    Keep the Overall Rate the same but vary the codeword length z
    '''
    ...
    z_values = [i for i in range(3,19)]
    ...
    data['codeword_length'] = code_word_lengths
    #data['rates'] = rates
