...
if __name__ == '__main__':
    '''
    Keep the Overall Rate the same but vary the probability of substitution 
    '''
    ...
    for j,ps in enumerate(ps_values):    
        ...
        progress_bar(j+1,len(ps_values))

    
    rates = [0.5*k/(2*n) for _ in range(len(ps_values)) ]
    #code_word_lengths = [z*24 for z in z_values]
    ...
    data['rates'] = rates
    data['Probability of substitution'] = ps_values
